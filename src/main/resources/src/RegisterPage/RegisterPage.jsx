...
class RegisterPage extends React.Component {
    ...
    handleSubmit(event) {
        ...
        const { user } = this.state;
        if (user.username && user.email && user.password && user.confirm && user.password == user.confirm) {
            ...
            <div className="col-md-6 col-md-offset-3">
                ...
                <form name="form" onSubmit={this.handleSubmit}>
                    ...
                    <div className={'form-group' + (submitted && !user.confirm ? ' has-error' : '')}>
                        ...
                        {submitted && user.password != user.confirm &&
                            <div className="help-block">confirm Password is not match</div>
                        }
                    </div>
